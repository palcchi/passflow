  ...
  return (
    <main className="scanner-page">
      <nav className="scanner-nav">
        <Link href="/admin" className="back-link light-back"><ArrowLeft size={16} /> Dashboard</Link>
        <span className="scanner-brand">PASSFLOW SCANNER</span>
      </nav>
      <QrScanner stationId={station.id} stationName={station.name} stationMode={station.mode} />
    </main>
  );
}
