...
const routes = ["/", "/login", "/register", "/account", "/unauthorized", "/admin", "/e/discoveries-2026", "/e/night-shift-sessions", "/e/discoveries-2026/claim", "/admin/events/evt_discoveries_2026/appearance", "/scan/main-entrance"];
const failures = [];
try {
