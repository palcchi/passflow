...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      event_designs: {
        Row: { id: string; event_id: string; created_by: string | null; kind: string; asset_type: string | null; name: string; figma_file_key: string; figma_node_id: string | null; figma_file_url: string; figma_url: string | null; figma_file_name: string | null; figma_version: string | null; preview_url: string | null; metadata: Json; last_synced_at: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; event_id: string; created_by?: string | null; kind: string; asset_type?: string | null; name: string; figma_file_key: string; figma_node_id?: string | null; figma_file_url: string; figma_url?: string | null; figma_file_name?: string | null; figma_version?: string | null; preview_url?: string | null; metadata?: Json; last_synced_at?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; event_id?: string; created_by?: string | null; kind?: string; asset_type?: string | null; name?: string; figma_file_key?: string; figma_node_id?: string | null; figma_file_url?: string; figma_url?: string | null; figma_file_name?: string | null; figma_version?: string | null; preview_url?: string | null; metadata?: Json; last_synced_at?: string | null; created_at?: string; updated_at?: string }
        Relationships: []
      }
      figma_connections: {
